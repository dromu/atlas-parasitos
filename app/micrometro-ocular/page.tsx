...
export default function MicrometroOcularPage() {
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      permite diferenciar quistes de <em>Entamoeba histolytica/E.dispar</em> con quistes de <em>Entamoeba hartmanni</em>; ooquistes de <em>Cryptosporidium parvum</em> de 
